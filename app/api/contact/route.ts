...
export async function POST(request: Request) {
  try {
      ...
      html: `
        <div style="font-family: 'Inter', 'Helvetica Neue', Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #ecffe2; padding: 30px; border-radius: 12px;">
          <div style="background-color: #045016; padding: 30px; border-radius: 12px 12px 0 0; text-align: center;">
            <h1 style="color: #ffffff; margin: 0; font-size: 28px; font-weight: 800; letter-spacing: -0.02em;">New Contact Inquiry</h1>
          ...
          <div style="background-color: #ffffff; padding: 40px; border-radius: 0 0 12px 12px; box-shadow: 0 10px 25px rgba(0,0,0,0.05);">
            ...
            <div style="background-color: #f8fbf7; border-left: 4px solid #045016; padding: 15px; border-radius: 0 8px 8px 0; color: #40493e; font-style: italic; line-height: 1.5; white-space: pre-wrap;">${message}</div>
            
          </div>
          <div style="text-align: center; margin-top: 25px; font-size: 12px; color: #717a6d; line-height: 1.5;">
            This inquiry was automatically generated by the ${siteConfig.companyName} portal.<br>
    ...
    return NextResponse.json({ success: true, message: 'Contact request submitted successfully' }, { status: 200 });
  } catch (error) {
